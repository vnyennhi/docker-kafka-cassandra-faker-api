...
This is the guiding solution for task 2 in Assignment 1 of Big Data for Engineering course.
...
$ docker-compose -f faker-producer/docker-compose.yml down   # stop twitter producer
